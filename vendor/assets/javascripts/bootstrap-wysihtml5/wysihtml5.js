    ...
    wysihtml5.quirks.parseColorStyleStr = function(stylesStr, paramName) {
        ...
        if (params) {
            ...
            if (RGBA_REGEX.test(str)) {
                ...
                return [(parseInt(colorMatch[1], 16) * 16) + parseInt(colorMatch[1], 16), (parseInt(colorMatch[2], 16) * 16) + parseInt(colorMatch[2], 16), (parseInt(colorMatch[3], 16) * 16) + parseInt(colorMatch[3], 16),
                    1
                ];
            }
        }
